...
if !exists('g:nord_line_nr_brightness')
  let g:nord_line_nr_brightness = 6 
endif

if !exists('g:nord_uniform_status_lines')
  let g:nord_uniform_status_lines = 14
endif
...
call s:hi("LineNr", s:nord10_gui, s:nord0_gui, s:nord10_term, "NONE", "", "")
...
call s:hi("Visual", s:nord13_gui, s:nord0_gui, s:nord13_term, "NONE", "inverse", "")
...
if g:nord_cursor_line_number_background == 0
  call s:hi("CursorLineNr", s:nord4_gui, s:nord0_gui, s:nord13_term, "", "", "")
else
  call s:hi("CursorLineNr", s:nord13_gui, s:nord1_gui, s:nord13_term, s:nord1_term, "", "")
endif
call s:hi("Folded", s:nord8_gui, s:nord1_gui, s:nord8_term, s:nord1_term, "bold", "")
...
call s:hi("Comment", s:nord3_gui_brightened[g:nord_comment_brightness], s:nord0_gui, s:nord10_term, "", s:italicize_comments, "")
...
call s:hi("Identifier", s:nord4_gui, "", "NONE", "", s:italic, "")
...
call s:hi("Repeat", s:nord9_gui, "", s:nord9_term, "", s:italic, "")
...
call s:hi("Statement", s:nord9_gui, "", s:nord9_term, "", s:italic, "")
...
call s:hi("Type", s:nord9_gui, "", s:nord9_term, "", s:italic, "")
...
hi! link jsClassKeyword StorageClass
hi! link jsExtendsKeyword StorageClass
hi! link jsThis StorageClass
hi! link jsSuper StorageClass
hi! link jsImport StorageClass
hi! link jsFrom StorageClass
